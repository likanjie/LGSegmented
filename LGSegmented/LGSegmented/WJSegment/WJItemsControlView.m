...
-(id)init
{
    ...
    if(self){
        ...
        _itemWidth = 0;
        _itemFont = [UIFont boldSystemFontOfSize:13];
        _textColor = [UIColor colorWithRed:100/255.0 green:108/255.0 blue:108/255.0 alpha:1];
        _selectedColor = [UIColor orangeColor];//[UIColor colorWithRed:61/255.0 green:209/255.0 blue:165/255.0 alpha:1];
//        _linePercent = 0.8;
//        _lineHieght = 2.5;
    }
    return self;
